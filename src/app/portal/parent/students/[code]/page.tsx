...
export default function ParentStudentFilePage() {
    ...
    <main className="min-h-screen px-6 pb-24 pt-10">
      <div className="mx-auto w-full max-w-5xl">
        <header className="mb-8 flex items-center justify-between">
          <h1 className="app-heading mt-2">ملف الابن</h1>
          <BackButton
        ...
        {!loading && !error && data ? (
          <div className="grid gap-6">
            <section className="rounded-3xl border border-white/20 bg-white/15 p-6 text-white shadow-[var(--shadow)] backdrop-blur-md">
              ...
              <div className="mt-3">
                <label className="text-sm text-white/85">تحديث صورة الابن</label>
                <input
                  type="file"
                  accept="image/*"

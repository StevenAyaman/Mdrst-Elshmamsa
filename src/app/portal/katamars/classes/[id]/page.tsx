...
export default function KatamarsClassDetailsPage() {
  ...
  const filteredStudents = useMemo(() => {
    ...
    return groups.students
      .filter((student) => {
        ...
        const byParent = student.parentCodes.some((parentCode) => parentCode.toLowerCase().includes(term));
        ...
        <header className="mb-6 grid gap-3">
          ...
          <div className="flex justify-end">
            <BackButton
              ...
              fallbackHref={"/portal/katamars/classes"}
            />
          </div>
        </header>
